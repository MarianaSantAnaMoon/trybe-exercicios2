...
Questão 3: Crie uma função que verifica se uma determinada chave existe em todos os elementos do array lessons.
O retorno deve ser um booleano (true ou false). Essa função deve possuir dois parâmetros: o objeto e o nome da chave.

Questão 4: Crie uma função para alterar o turno para noite no curso de Python.
